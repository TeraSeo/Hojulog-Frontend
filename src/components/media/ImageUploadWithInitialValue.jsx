...
const ImageUploadWithInitialValue = ({ imagesDropzone, existingImages, newImages, removeImage, errors }) => (
  <Grid item xs={12}>
            ...
            {existingImages.map((imageUrl, index) => (
                    <Box 
                        ...
                        sx={{
                            ...
                            <CardMedia component="img" image={imageUrl} alt={`기존 이미지 ${index + 1}`} sx={{ width: "100%", height: "100%" }} />
                            <IconButton
...
export default ImageUploadWithInitialValue;