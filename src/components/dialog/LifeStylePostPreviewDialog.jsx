...
import LifeStyleDetailedPostDialog from "./LifeStyleDetailedPostDialog";

const LifeStylePostPreviewDialog = ({ open, onClose, mainInfoData, mediaData = {} }) => {
...
export default LifeStylePostPreviewDialog;