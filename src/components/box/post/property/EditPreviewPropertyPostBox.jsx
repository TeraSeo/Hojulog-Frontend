...
import EditPropertyDetailedPreviewDialog from "../../../preview/property/EditPropertyDetailedPreviewDialog";
import { PostImageWidthResponiveSize } from "../../../../constant/ComponentSizeResponsive";

const EditPreviewPropertyPostBox = ({ post, mediaData, subCategory, existingImages=[] }) => {
    ...
    return (
        ...
        >
            ...
            <EditPropertyDetailedPreviewDialog open={dialogOpen} onClose={handleCloseDialog} post={post} mediaData={mediaData} subCategory={subCategory} existingImages={existingImages} />
        </Box>
    );
};

export default EditPreviewPropertyPostBox;