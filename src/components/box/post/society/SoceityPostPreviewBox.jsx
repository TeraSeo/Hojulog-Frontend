...
import SocietyPostDetailedPreviewDialog from "../../../preview/society/SocietyPostDetailedPreviewDialog";

const SoceityPostPreviewBox = ({ post, subCategory }) => {
    ...
    return (
        <Box>
                        ...
                        <Box>
                            ...
                            >
                                ...
                                <Box sx={{ display: "flex", gap: 1 }}>
                                    ...
                                    <HomePostCommentCountsText isCommentAllowed={post.isCommentAllowed} commentsCounts={0} postId={post.postId} />
            ...
            <SocietyPostDetailedPreviewDialog open={dialogOpen} onClose={handleCloseDialog} post={post} subCategory={subCategory} />
        </Box>
    );
};

export default SoceityPostPreviewBox;