...
const CommonOwnSummarizedPostBox = ({ postId }) => {
                    ...
                    <Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                            <Box sx={{whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis",}}>
                                <SummarizedOwnPostTitleText title={summarizedOwnPost.title} postId={postId} category={summarizedOwnPost.category} />
                            </Box>
...
export default CommonOwnSummarizedPostBox;