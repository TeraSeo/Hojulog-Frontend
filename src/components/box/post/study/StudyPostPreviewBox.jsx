...
import StudyPostDetailedPreviewDialog from "../../../preview/study/StudyPostDetailedPreviewDialog";

const StudyPostPreviewBox = ({ post, subCategory }) => {
    ...
    return (
        <Box>
            ...
            <StudyPostDetailedPreviewDialog open={dialogOpen} onClose={handleCloseDialog} post={post} subCategory={subCategory} />
        </Box>
    );
};

export default StudyPostPreviewBox;