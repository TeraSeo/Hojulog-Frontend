...
import EditJobDetailedPreviewDialog from "../../../preview/job/EditJobDetailedPreviewDialog";
import PreviewTitleText from "../../../texts/preview/PreviewTitleText";

const EditPreviewJobPostBox = ({ post, mediaData, subCategory, existingImages=[] }) => {
    ...
    return (
        ...
        >
            ...
            <EditJobDetailedPreviewDialog open={dialogOpen} onClose={handleCloseDialog} post={post} mediaData={mediaData} subCategory={subCategory} existingImages={existingImages} />
        </Box>
    );
};

export default EditPreviewJobPostBox;