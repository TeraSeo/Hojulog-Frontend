...
import { transactionKeyWords } from "../../constant/Keywords";
import { primaryColor } from "../../constant/Color";

const TransactionKeyWordField = ({ selectedKeywords, error, onChange }) => {
    ...
    return (
      <Grid item xs={12} sx={{ mb: 3 }}>
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
          {transactionKeyWords.map((keyword) => (
            <Chip
              key={keyword}
              label={keyword}
  ...
  export default TransactionKeyWordField;