...
import { societyKeyWords } from "../../constant/Keywords";
import { primaryColor } from "../../constant/Color";

const SocietyKeyWordField = ({ selectedKeywords, error, onChange }) => {
  ...
  export default SocietyKeyWordField;