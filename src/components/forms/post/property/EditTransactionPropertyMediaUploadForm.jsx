...
const EditTransactionPropertyMediaUploadForm = ({ onMediaChange, setIsMediaValid, existingImages, setExistingImages }) => {
...
export default EditTransactionPropertyMediaUploadForm;