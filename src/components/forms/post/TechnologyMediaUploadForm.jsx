...
const TechnologyMediaUploadForm = ({ onMediaChange, setIsMediaValid }) => {
  ...
  const validateMedia = () => {
    ...
    } else if (!logoImage.type.startsWith("image/")) {
  ...
  return (
    <Paper elevation={3} sx={{ padding: 4, borderRadius: 3 }}>
      ...
      <Typography variant="body2" color="textSecondary" sx={{ marginBottom: 3 }}>
        Upload your logo, images, and videos. The first image will be used as the social preview
        when your link is shared online.
      </Typography>
