...
const EditEtcTransactionMediaUploadForm = ({ onMediaChange, setIsMediaValid, existingImages, setExistingImages }) => {
...
export default EditEtcTransactionMediaUploadForm;