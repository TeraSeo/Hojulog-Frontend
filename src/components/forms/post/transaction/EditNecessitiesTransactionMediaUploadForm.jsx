...
const EditNecessitiesTransactionMediaUploadForm = ({ onMediaChange, setIsMediaValid, existingImages, setExistingImages }) => {
...
export default EditNecessitiesTransactionMediaUploadForm;