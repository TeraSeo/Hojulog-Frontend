...
const EditCarTransactionMediaUploadForm = ({ onMediaChange, setIsMediaValid, existingImages, setExistingImages }) => {
...
export default EditCarTransactionMediaUploadForm;