...
const EditRestaurantMainInfoForm = ({ onDataChange, setIsFormValid, mainInfoData }) => {
  const [formValues, setFormValues] = useState({
    postId: mainInfoData.postId,
    title: mainInfoData.title,
    travelSuburb: mainInfoData.travelSuburb,
...
export default EditRestaurantMainInfoForm;