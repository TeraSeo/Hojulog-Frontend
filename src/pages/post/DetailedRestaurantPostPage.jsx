...
import RestaurantDetailedPostBox from "../../components/box/post/RestaurantDetailedPostBox";

function DetailedRestaurantPostPage() {
    ...
    return (
        ...
        >
            <Box sx={{ marginBottom: 4 }}>
                <RestaurantDetailedPostBox postData={postData} wholeCommentsLength={postData.wholeCommentsLength} />
            </Box>
...
export default DetailedRestaurantPostPage;