...
const LaunchIdealTypeWorldCupPage8 = () => {
  const navigate = useNavigate();
  
  const [groups, setGroups] = useState(
    Array.from({ length: 8 }, () => ({ title: "", image: null, imageUrl: "" }))
  );
  ...
  const [groupErrors, setGroupErrors] = useState(Array(8).fill("각 조의 제목을 입력해주세요."));
...
export default LaunchIdealTypeWorldCupPage8;