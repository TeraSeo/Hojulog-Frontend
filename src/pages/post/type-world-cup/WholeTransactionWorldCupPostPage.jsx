...
function WholeTransactionWorldCupPostPage() {
    ...
    const fetchPageData = (page) => {
        getWorldCupPostsBySubCategoryNPage("사고팔기", page, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
    ...
    const applyFilters = () => {
        getWorldCupPostsBySubCategoryNPage("사고팔기", 1, selectedSortOption)
                .then((data) => {
                    setWorldCupPageData({
                        posts: data.posts,
                        pageSize: data.pageSize,
...
export default WholeTransactionWorldCupPostPage;