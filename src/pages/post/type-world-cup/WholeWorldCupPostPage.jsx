...
import { getWorldCupPostsByPage } from "../../../service/PostService";
import PostPaginationBox from "../../../components/box/post/PostPaginationBox";
import PageTitleText from "../../../components/texts/PageTitleText";
import { CommonPagePaddingXSize } from "../../../constant/PaddingResponsiveSize";
import WorldCupPostBox from "../../../components/box/post/world-cup/WorldCupPostBox";
import AussieChoiceAddPostButton from "../../../components/buttons/post/aussie-choice/AussieChoiceAddPostButton";
import WorldCupFilter from "../../../components/box/post/world-cup/WorldCupFilter";

function WholeWorldCupPostPage() {
    ...
    const fetchPageData = (page) => {
        getWorldCupPostsByPage(page, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
    ...
    const applyFilters = () => {
        getWorldCupPostsByPage(1, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
                    pageSize: data.pageSize,
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={9}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", mb: 2 }}>
                        <PageTitleText title={"Aussie Choice"} />
...
export default WholeWorldCupPostPage;