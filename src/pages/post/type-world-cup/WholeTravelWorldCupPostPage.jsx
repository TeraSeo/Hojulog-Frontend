...
function WholeTravelWorldCupPostPage() {
    ...
    const fetchPageData = (page) => {
        getWorldCupPostsBySubCategoryNPage("여행", page, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
    ...
    const applyFilters = () => {
        getWorldCupPostsBySubCategoryNPage("여행", 1, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
                    pageSize: data.pageSize,
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={9}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", mb: 2 }}>
                        <PageTitleText title={"여행 Aussie Choice"} />
                    ...
                    <AussieChoiceNonOptionAddPostButton subCategory={"여행"} />
...
export default WholeTravelWorldCupPostPage;