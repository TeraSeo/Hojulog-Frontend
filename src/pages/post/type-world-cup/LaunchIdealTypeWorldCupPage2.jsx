...
const LaunchIdealTypeWorldCupPage2 = () => {
  ...
  const [groupErrors, setGroupErrors] = useState(["각 조의 제목을 입력해주세요.", "각 조의 제목을 입력해주세요."]); 
    ...
    >
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <CommentAvailabilityField
          ...
          onChange={handleIsCommentAllowed} 
        />
...
export default LaunchIdealTypeWorldCupPage2;