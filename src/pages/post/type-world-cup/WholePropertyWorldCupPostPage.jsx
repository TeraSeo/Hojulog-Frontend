...
function WholePropertyWorldCupPostPage() {
    ...
    const fetchPageData = (page) => {
        getWorldCupPostsBySubCategoryNPage("부동산", page, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
    ...
    const applyFilters = () => {
        getWorldCupPostsBySubCategoryNPage("부동산", 1, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
                    pageSize: data.pageSize,
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={9}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", mb: 2 }}>
                        <PageTitleText title={"부동산 Aussie Choice"} />
                    ...
                    <AussieChoiceNonOptionAddPostButton subCategory={"부동산"} />
...
export default WholePropertyWorldCupPostPage;