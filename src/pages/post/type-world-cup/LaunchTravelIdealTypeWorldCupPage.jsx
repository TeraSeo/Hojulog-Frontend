...
import { worldCupTravelKeyWords } from "../../../constant/Keywords";

const candidateOptions = [2, 4, 8, 16];

const LaunchTravelIdealTypeWorldCupPage = () => {
    ...
    <Paper elevation={3} sx={{ padding: 4, margin: 4, maxWidth: 800, mx: "auto", backgroundColor: "#f7f9fc" }}>
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        <WorldCupKeyWordField
                ...
                availableKeywords={worldCupTravelKeyWords}
            />
      </Box>
...
export default LaunchTravelIdealTypeWorldCupPage;