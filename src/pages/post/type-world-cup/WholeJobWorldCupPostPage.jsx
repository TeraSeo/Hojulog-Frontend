...
function WholeJobWorldCupPostPage() {
    ...
    const fetchPageData = (page) => {
        getWorldCupPostsBySubCategoryNPage("구인구직", page, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
    ...
    const applyFilters = () => {
        getWorldCupPostsBySubCategoryNPage("구인구직", 1, selectedSortOption)
            .then((data) => {
                setWorldCupPageData({
                    posts: data.posts,
                    pageSize: data.pageSize,
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={9}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", mb: 2 }}>
                        <PageTitleText title={"구인구직 Aussie Choice"} />
                    ...
                    <AussieChoiceNonOptionAddPostButton subCategory={"구인구직"} />
...
export default WholeJobWorldCupPostPage;
