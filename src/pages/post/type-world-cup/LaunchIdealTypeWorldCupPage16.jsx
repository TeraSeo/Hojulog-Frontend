...
const LaunchIdealTypeWorldCupPage16 = () => {
  const navigate = useNavigate();

  const [groups, setGroups] = useState(
    Array.from({ length: 16 }, () => ({ title: "", image: null, imageUrl: "" }))
  );
  ...
  const [groupErrors, setGroupErrors] = useState(Array(16).fill("각 조의 제목을 입력해주세요."));
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        ...
        {[0, 2, 4, 6, 8, 10, 12, 14].map((groupIndex) => (
...
export default LaunchIdealTypeWorldCupPage16;