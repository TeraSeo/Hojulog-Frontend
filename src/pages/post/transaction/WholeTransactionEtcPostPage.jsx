...
const WholeTransactionEtcPostPage = () => {
    ...
    const fetchPageData = (page) => {
        getTransactionEtcPostsByPage(page, filters.transactionType, filters.priceType, selectedSortOption)
            .then((data) => {
                setPostPageData({
                    posts: data.posts,
    ...
    const applyFilters = () => {
        getTransactionEtcPostsByPage(1, filters.transactionType, filters.priceType, selectedSortOption)
            .then((data) => {
                setPostPageData({
                    posts: data.posts,
                    pageSize: data.pageSize,
        ...
        <Box sx={{ py: "10px", px: CommonPagePaddingXSize }}>
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={9}>
                    ...
                    <TransactionNonOptionPostAddButton subCategory={"기타"} />
